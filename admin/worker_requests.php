...
// Also pending shops for a comprehensive "Requests" view if needed, but dashboard has that.
// Let's stick to Worker Requests as the sidebar says.
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Worker Requests - Road Mithra</title>
...
<div class="app-layout">
    <aside class="sidebar">
        ...
        <a href="worker_requests.php" class="nav-link active"><i class="fa-solid fa-clipboard-list"></i> Worker Requests</a>
    ...
    <div class="main-area">
        <header class="top-bar">
            <div class="top-bar-title">
                ...
                <p>Approve or reject new worker registrations</p>
            </div>
        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="table-container">
                    <table class="data-table">
                        <thead><tr><th>Name</th><th>Type</th><th>Applying For Shop</th><th>Phone</th><th>Date</th><th>Action</th></tr></thead>
                        <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($w['registered_shop_name'] ?: ($w['shop_name'] ?: 'None')); ?></td>
                            <td><?php echo $w['phone']; ?></td>
                            <td style="font-size:12px;"><?php echo date('d M Y', strtotime($w['created_at'])); ?></td>
                            <td style="display:flex;gap:6px;">
                                <a href="approve_worker.php?id=<?php echo $w['id']; ?>" class="btn btn-sm btn-success">Approve</a>
                                <a href="delete_worker.php?id=<?php echo $w['id']; ?>" class="btn btn-sm" style="background:#FEE2E2;color:var(--danger);" onclick="return confirm('Reject this request?')">Reject</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                        </tbody>
            ...
            <div class="card" style="text-align:center;padding:40px;">
                ...
                <h3>All Caught Up!</h3>
                <p>There are no pending worker requests at the moment.</p>
            </div>
            <?php endif; ?>
        </div>
    </div>
