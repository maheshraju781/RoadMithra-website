...
$query = "SELECT * FROM shop_owners WHERE shop_type='mechanic' ORDER BY created_at DESC";
...
<head>
    ...
    <title>Manage Mechanics - Road Mithra</title>
...
<div class="app-layout">
    <aside class="sidebar">
        ...
        <a href="manage_mechanics.php" class="nav-link active"><i class="fa-solid fa-wrench"></i> Mechanic Shops</a>
    ...
    <div class="main-area">
        <header class="top-bar">
            <div class="top-bar-title">
                ...
                <p>Manage all registered mechanic shops and their approval status</p>
            </div>
